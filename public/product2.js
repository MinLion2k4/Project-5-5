        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-around mb-3">
              <h3>${parseInt(product.Price).toLocaleString("vi-VN", {
                style: "currency",
                currency: "VND",
              })}/con</h3>
              <button class="btn btn-primary" data-product-name="${
                product.Name
              }" data-product-id="${product.id}" data-product-image="${
        product.img
      }" data-product-price="${
        product.Price
      }" onclick="addToCart(event)">Mua Ngay</button>
            </div>
          </div>
        </div>
      </div>
